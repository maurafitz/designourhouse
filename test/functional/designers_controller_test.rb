...
class DesignersControllerTest < ActionController::TestCase
  ...
  test "should create designer" do
    assert_difference('Designer.count') do
      post :create, designer: { description: @designer.description, specialization_category_id: @designer.specialization_category_id, user_id: @designer.user_id }
    end
  ...
  test "should update designer" do
    put :update, id: @designer, designer: { description: @designer.description, specialization_category_id: @designer.specialization_category_id, user_id: @designer.user_id }
    assert_redirected_to designer_path(assigns(:designer))
  end
